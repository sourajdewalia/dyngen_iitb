  ...
  common& cmn)
{
  ...
  a7 = cmn.a6;
  far6 = wf6 / wa6;
  procom(far6, t6, xxi, xx2, xx3, xx4, phz6, xx6);
  wqa = wg6 / a7;
  ...
  statement_1:
  FEM_DO_SAFE(i, 1, 15) {
    procom(far6, ts7, cs7, ak7, cp7, rex7, phis7, hs7);
    v7 = am7 * cs7;
  ...
  thermo(p7, ha, t7, xx1, xx2, 1, far6, 0);
  //C
  ...
  //C
  //C ***    MOMENTUM  LOSS
  procom(far7, t7, xx1, xx2, xx3, rex7, phi7, h7);
  ...
  thermo(1.0f, hs7, ts7, phis7, xx2, 1, far7, 1);
  if (ts7 >= 301.f) {
    goto statement_18;
  }
  thermo(1.0f, hs7, 400.f, phis7, xx2, 1, far7, 0);
  ...
  procom(far7, ts7, cs7, xx2, xx3, xx6, xx5, xx6);
  aht = vt / cs7;
  statement_20:
  thermo(p7, h7, t7, s7, xx2, 1, far7, 0);
  if (vaftbn == 0.0f) {
    goto statement_31;
  }
  q(2) = 0.0f;
