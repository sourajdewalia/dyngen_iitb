...
//C        THIS IS A GENERALIZED FAN MAP FOR UNREALISTIC SUPERSONIC ENGINE
//C        BLOCK DATA
//C
void
program_unnamed(
  ...
  char const* argv[])
{
  ...
  if (is_called_first_time) {
    ...
    {
      static const float values[] = {
        1.00090f, 286.800f, 0.75592f, 1.02000f, 270.000f, 0.77161f,
    ...
    }
    {
      static const float values[] = {
        1.00000f, 439.800f, 0.72512f, 1.06400f, 436.800f, 0.77616f,
          ...
          1.18400f, 406.800f, 0.88000f, 1.20960f, 393.600f, 0.90112f,
          1.21760f, 388.200f, 0.90376f, 1.22400f, 383.400f, 0.90112f,
          1.24400f, 368.400f, 0.88000f, 1.26720f, 342.600f, 0.82808f
      };
      fem::data_of_type<float> data(FEM_VALUES_AND_SIZE);
      FEM_DO_SAFE(j, 1, 10) {
    ...
    {
      static const float values[] = {
        1.00000f, 499.800f, 0.68816f, 1.10000f, 499.800f, 0.77616f,
          1.16000f, 493.200f, 0.82808f, 1.20000f, 485.400f, 0.85448f,
          1.22800f, 476.400f, 0.88000f, 1.25520f, 466.800f, 0.90112f,
          1.27200f, 456.600f, 0.91080f, 1.28640f, 448.200f, 0.90112f,
    ...
    {
      static const float values[] = {
        1.90009f, 566.400f, 0.64152f, 1.97600f, 566.400f, 0.72512f,
          1.15200f, 566.400f, 6.77616f, 1.21920f, 559.800f, 0.82808f,
          1.26000f, 553.200f, 0.85888f, 1.28960f, 544.800f, 0.88000f,
          1.33120f, 528.600f, 0.90112f, 1.36169f, 509.400f, 0.88000f,
          1.39120f, 483.600f, 0.82808f, 1.40000f, 474.000f, 0.81752f
      };
      fem::data_of_type<float> data(FEM_VALUES_AND_SIZE);
      FEM_DO_SAFE(j, 1, 10) {
    ...
    }
    {
      static const float values[] = {
        1.30990f, 633.600f, 0.60016f, 1.04400f, 633.600f, 0.64152f,
          ...
          1.29440f, 625.800f, 0.82808f, 1.34000f, 616.809f, 0.85666f,
    ...
    {
      static const float values[] = {
        1.00000f, 700.200f, 0.56936f, 1.10400f, 700.200f, 0.54152f,
          1.22000f, 700.200f, 0.72512f, 1.32400f, 700.200f, 0.77616f,
          1.40990f, 700.200f, 0.80256f, 1.44800f, 698.400f, 0.80784f,
          1.50000f, 603.600f, 0.80256f, 1.53160f, 683.400f, 0.77616f,
          1.56800f, 666.600f, 0.74536f, 1.58400f, 656.400f, 0.75212f
      };
      fem::data_of_type<float> data(FEM_VALUES_AND_SIZE);
      FEM_DO_SAFE(j, 1, 10) {
    ...
    }
    {
      static const float values[] = {
        1.00000f, 750.000f, 0.51744f, 1.16320f, 750.000f, 0.64152f,
          ...
          1.58900f, 749.400f, 9.72512f, 1.66000f, 736.800f, 0.64152f
      };
      fem::data_of_type<float> data(FEM_VALUES_AND_SIZE);
      FEM_DO_SAFE(j, 1, 8) {
