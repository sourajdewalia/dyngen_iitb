  ...
  common& cmn)
{
  ...
  if (is_called_first_time) {
    fem::data((values, 11, 9*datum(15), 12, 9, 4*datum(0.f))), cmn.n, np;
    {
      fem::data_values data;
      data.values, 70.776f, 82.236f, 93.468f, 103.464f, 112.836f,
        116.680f, 120.000f, 122.676f;
      data.values, 125.126f, 127.826f, 130.536f, 4*datum(0.f);
      data, tff;
    }
    {
    ...
    {
      static const float values[] = {
        0.3522f, 0.0027f, 0.8000f, 0.5656f, 0.0045f, 0.8300f,
    ...
    }
    {
      static const float values[] = {
        0.3522f, 0.0029f, 0.7995f, 0.6052f, 0.0034f, 0.8000f,
          0.6516f, 0.0056f, 0.8600f, 0.8652f, 0.0069f, 0.8600f,
    ...
    }
    {
      static const float values[] = {
        0.3522f, 0.0031f, 0.7750f, 0.4844f, 0.0043f, 0.8000f,
          ...
          1.6548f, 0.0136f, 0.8912f, 1.8834f, 0.0152f, 0.8940f,
    ...
    {
      static const float values[] = {
        0.3522f, 0.0047f, 0.7100f, 0.5808f, 0.0069f, 0.7450f,
    ...
    }
    {
      static const float values[] = {
        0.3522f, 0.0047f, 0.6780f, 0.5278f, 0.0070f, 0.7000f,
          0.6340f, 0.0084f, 0.7125f, 0.7922f, 0.0104f, 0.7350f,
          ...
          1.6722f, 0.0216f, 0.8470f, 1.7609f, 0.0232f, 0.8225f,
