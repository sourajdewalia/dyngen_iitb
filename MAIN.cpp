  ...
  int& icon)
{
  ...
  statement_1:
  j++;
  procom(cmn, far, tss, css, akicp, rexs, phiss, hss);
  ...
  tst = tso;
  procom(cmn, far, tst, cst, ak, gp, rex, phist, hst);
  ...
  int& icon)
{
  ...
  /* float const& szi */ units.bind<float>();
  bool zi = fem::bool0;
  float aj = fem::float0;
  float capsf = fem::float0;
  float g = fem::float0;
  ...
  common& cmn)
{
  ...
  convrg(cmn, t37, h37, p37, s37, 0.0f, wg37, cmn.p1, ides, a38,
    p38r, t38, h3s38, ts38, ps38, v38, am38, icon);
  switch (icon) {
    case 1: goto statement_5;
  ...
  common& cmn)
{
  ...
  //C
  convrg(cmn, t7, h7, p7, s7, far7, cmn.wgt, p1, imnoz, ab, p7r, t8,
    h8, pb, s8, ts8, ps8, v8, am8, icon);
  //C
  switch (icon) {
  ...
  common& cmn)
{
  ...
  ts55 = 0.875f * t55;
  FEM_DO_SAFE(i, 1, 15) {
    procom(cmn, ifar55, ts55, cs55, ak55, cp55, rex55, phis55, hs55);
    v55 = am55 * cs55;
